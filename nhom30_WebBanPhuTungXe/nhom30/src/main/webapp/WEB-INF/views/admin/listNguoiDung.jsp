																		...
																		<table id="datatable"
																			...
																			<thead>
																				<tr role="row">
																					...
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 100px;">Ngày sinh</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 80px;">Giới tính</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 127px;">Địa chỉ</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 107px;">Số điện thoại</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																			...
																			<tbody>
																				<c:forEach items="${list}" var="nguoiDung"
																					varStatus="lop">
																					<tr role="row" class="odd">
																						<td>${lop.index+1}</td>
																						<td>${nguoiDung.hoTenKh}</td>
																						...
																						<td><a style="font-size: 1.5em; color: red"
																							href="nguoi-dung/delete/${nguoiDung.maKh}"><i
																								class="fa fa-close"></i></a> <a
																							style="font-size: 1.5em; color: blue"
																							href="nguoi-dung/edit/${nguoiDung.maKh}"><i

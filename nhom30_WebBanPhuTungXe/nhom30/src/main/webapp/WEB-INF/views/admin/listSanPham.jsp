																		...
																		<table id="datatable"
																			...
																			<thead>
																				<tr role="row">
																					...
																					<th class="sorting_asc" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 250px;">Tên sản phẩm</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 180px;">Thương hiệu</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 127px;">Giá gốc</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 107px;">Xuất xứ</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 120px;">Hình ảnh</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																			...
																			<tbody>
																				<c:forEach items="${list}" var="item"
																					...
																					<tr role="row" class="odd">
																						...
																						<td><%-- <a style="font-size: 1.5em; color: green"
																							href="view/${item.maSp}"><i class="fa fa-eye"></i></a> --%>
																							<a style="font-size: 1.5em; color: red"
																							href="delete/${item.maSp}"><i
																								class="fa fa-close"></i></a> <a
																							style="font-size: 1.5em; color: blue"
																							href="edit/${item.maSp}"><i

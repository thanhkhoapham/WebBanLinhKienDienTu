						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_content">
									...
									<!-- -------------------------------------------------------Form -->
									<form action="addPerson" method="post" id="demo-form2"
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="hoTenKh" id="first-name"
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align"
												for="last-name">Mật khẩu: <span class="required">(Mặc
													định là 111)</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="111" type="password" id="" name="matKhau"
													required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="diaChi"
													required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="soDienThoai"
													required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<div id="gender" class="btn-group" data-toggle="buttons">
													<label class="btn btn-secondary"
														...
														type="radio" required="required" name="gioiTinh"
														value="Nam" class="join-btn"> &nbsp;Nam&nbsp;
													</label> <label class="btn btn-primary"
														data-toggle-class="btn-primary"
														data-toggle-passive-class="btn-default"> <input
														style="padding-left: 20px;" type="radio"
														required="required" name="gioiTinh" value="Nu"
														class="join-btn"> &nbsp;&nbsp;&nbsp;&nbsp;Nữ
													</label>
												</div>
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="birthday" class="date-picker form-control"
													...
													onmouseout="timeFunctionLong(this)" name="ngaySinh">
												<script>

																		...
																		<table id="datatable"
																			...
																			<thead>
																				<tr role="row">
																					...
																					<th class="sorting_asc" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 150px;">Khách hàng</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 250px;">Ngày lập hóa đơn</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 207px;">Nơi nhận</th>
																					<th class="sorting" tabindex="0"
																						aria-controls="datatable" rowspan="1" colspan="1"
																						style="width: 67px;">Thao tác</th>
																				</tr>
																			</thead>
																				...
																				<c:forEach items="${list}" var="item"
																					...
																					<tr role="row" class="odd">
																						...
																						<td><a style="font-size: 1.5em; color: green"
																							href="view/${item.maHd}"><i class="fa fa-eye"></i></a>
																							<a style="font-size: 1.5em; color: red"
																							href="delete/${item.maHd}"><i

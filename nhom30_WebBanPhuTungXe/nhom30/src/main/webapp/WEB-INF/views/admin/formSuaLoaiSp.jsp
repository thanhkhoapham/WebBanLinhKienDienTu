						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_content">
									...
									<!-- -------------------------------------------------------Form -->
									<form action="update-LoaiSp/${loaiSpEdit.maLoaiSp}"
										method="post" id="demo-form2" data-parsley-validate
										class="form-horizontal form-label-left">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align"
												for="last-name">Tên loại sản phẩm: <span
												class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="${loaiSpEdit.tenLoaiSp}" type="text" id="last-name"
													name="tenLoaiSp" required="required" class="form-control">
											</div>
										</div>
